...
public class FinderMethodsTestRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		/*
		 * System.out.
		 * println("========finder methods with multiple properties based conditions========="
		 * ); repo.findByMidGreaterThanAndRatingLessThan(300,
		 * 5.0f).forEach(System.out::println);
		 * System.out.println("---------------------");
		 * repo.findByMnameStartingWithOrRatingBetween("R", 3.0f,
		 * 4.5f).forEach(System.out::println);
		 * System.out.println("--------------------");
		 * repo.findByYearInOrMnameContainingIgnoreCaseAndRatingBetween(List.of("2021",
		 * "2022"), "r", 3.0f, 5.0f) .forEach(System.out::println);
		 * System.out.println("--------------------");
		 * repo.findByMnameNotLikeAndYearInOrderByMnameAsc("R%", List.of("2021",
		 * "2022")).forEach(System.out::println);
		 */
	}
