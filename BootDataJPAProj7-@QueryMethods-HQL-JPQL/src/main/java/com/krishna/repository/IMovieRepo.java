...
public interface IMovieRepo extends JpaRepository<Movie, Integer> {
	...
	/*
	 * @Query("from Movie  where mid>=:min and mid<=:max") public List<Movie>
	 * searchMoviesByIdRange(@Param("min") int start,@Param("max") int end);
	 */
	...
	public List<Movie> searchMoviesByMnames(String name1, String name2, String name3); // taking array /var args
																						// /collection params
																						// multiple named params or
																						// postional params is not
																						// allowed
